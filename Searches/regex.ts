const container = document.querySelector(".regular-expression-container") as HTMLDivElement

const expressions = JSON.parse(localStorage.getItem("customRegularExpressions"))
const regContainer = document.querySelector(".regular-expression-container") as HTMLDivElement
const copySpot = document.getElementById("copy-spot") as HTMLInputElement
