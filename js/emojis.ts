...
function removeCustomEmojiOption(){
  try{
    document.getElementById('custom-emoji-dropdown').removeChild(document.getElementById((document.getElementById('remove-custom-emote') as HTMLInputElement).value))
  }
  catch(err){
  }
}
